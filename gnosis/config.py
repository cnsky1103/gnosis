...
DEFAULT_LLM_MODEL = os.environ.get("LLM_MODEL", "deepseek-v4-flash")
...
VOICES = ['logos', 'wanqing', 'baitie', 'yinxian', 'xuerong', 'zhijian', 'maenna', 'heijiaoS', 'xunshi', 'cangtai', 'liuming', 'duanya', 'zuole', 'anjielina', 'haruka', 'red', 'raidian', 'perfumer', 'shenxun', 'tianhuo', 'yela', 'wenmi', 'yu', 'xingzhu', 'dibi', 'simang', 'exusiai', 'miu', 'shihuaiya', 'ling', 'jijing', 'luwuguan', 'botani']
